      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {news.map((article, index) => (
            <Card key={article.id} className="bg-gray-800 border-gray-700 hover:shadow-xl transition-all duration-300 animate-fade-in">
              <CardHeader>
              ...
              <CardContent>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="ghost" size="sm" className="text-purple-400 hover:text-purple-300 hover:bg-gray-700">
                    Citește mai mult
